...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com//"></a><a href="https://github.com//dIscoRD-zaPret">/dIscoRD-zaPret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
Скачать dIscoRD-zaPret — запрет Discord (голос / RTC), обход DPI без VPN. Актуальная сборка в [Releases](./releases/latest) → 1.9.9c
</div>
...
> Если вы наткнулись на что-то вне репозитория `/dIscoRD-zaPret`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы релиза](./releases/latest) — `zapret-discord-youtube-1.9.9c.rar` или `zapret-discord-youtube-1.9.9c.zip`
...
Если этого не произошло, то см. [#522](https://github.com//dIscoRD-zaPret/issues/522)
...
- См. [#765](https://github.com//dIscoRD-zaPret/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](./releases/latest) (`zapret-discord-youtube-1.9.9c.rar` / `zapret-discord-youtube-1.9.9c.zip`)
...
- См. также [#251](https://github.com//dIscoRD-zaPret/discussions/251)
...
- См. также [#252](https://github.com//dIscoRD-zaPret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com//dIscoRD-zaPret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com//dIscoRD-zaPret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com//dIscoRD-zaPret/blob/main/LICENSE.txt)
